...
function loadInstrContent() {
    var instrContent = [
        ...
        /* ind1 */ `<p>In this quick experiment, you will first see an empty frame appear on screen. <img src = "${stimFolder}frame.png" style="width: ${imgWidth}px; display: block; margin: 0 auto;"></p>`,
