...
function loadInstrContent() {
    var instrContent = [
        ...
        /* ind1 */ `<p>In this quick experiment, you will see an image of an <i> unfamiliar geometric object</i> on screen. This 'blob' will be accompanied by a bright red mug to give you a sense of context and scale in this 3D environment.</div>This will occur for <b>two images</b>.</p>`,
        /* ind2 */ `<p>These images will flash on screen for only a short amount of time, so pay close attention!</p><p>The goal is to take in what you see, and remember it as best you can. After each image, you'll be shown a grid of four images like the one you just saw. Your task, then, is to select the image out of the four that you remember seeing.</p>`,
        /* ind3 */ `<p>Sometimes, you may be unsure of your answer. This is okay, since the task is designed to be difficult, as images flash quickly!  In times like this, just give it your <b>best guess</b>, as we are interested in your <i>gut intuition</i>.</p><p>Please do your very best to remain as focused and attentive as possible, even at the end of the experiment. I know it is very difficult to stay focused for so long, especially when you are doing the same thing over and over. But remember, the experiment will be all over in less than ${String(estTotalRunTime)} minutes. Press the button below to begin.`,
    ];
