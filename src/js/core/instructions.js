...
function loadInstrContent() {
    var instrContent = [
        ...
        /* ind3 */ `<p>After this black and white image flashes on screen, it will get immediately covered up by the chaotic image below, just to make it hard for you to remember the first image! Ignore this image, as it will disappear quickly as well.<img src="${stimFolder}mask.png" style="width: ${imgWidth}px; display: block; margin: 0 auto;"></p>`,
